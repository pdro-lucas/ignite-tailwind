...
const fileItem = tv({
  ...
  variants: {
    state: {
      ...
      error: {
        container:
          "bg-error-25 border-error-300 dark:bg-error-500/5 dark:border-error-500/3",
    ...
    <div className={container()}>
      ...
      {state === "error" ? (
        <div className="flex flex-col items-start flex-1 gap-1">
          ...
          <button className="text-sm font-semibold underline text-error-700 hover:text-error-900 dark:text-error-400 dark:hover:text-error-300">
            Try again
          </button>
        </div>
      ) : (
        <div className="flex flex-col items-start flex-1 gap-1">
          ...
          <div className="flex items-center w-full gap-3">
            <div className="flex-1 h-2 rounded-full bg-zinc-100 dark:bg-zinc-600">
              <div
